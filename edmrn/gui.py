            ...
            self.section_content = {
                "whats_new": (
                    ...
                    [
                        ...
                        "",
                        "⛽ FUEL TRACKER (NEW)",
                        "  • Real-time fuel monitoring with overlay",
                        "  • Color-coded progress bar (green/yellow/orange/red)",
                        "  • Audio alerts when fuel drops below warning",
                        "  • On-foot detection (shows 'On Foot' when not in ship)",
                        "",
                        "🎯 CUSTOM ROUTE PLANNER (NEW)",
                        "  • TSP optimization for multi-stop routes",
                        "  • Neutron star boost support (x4/x6 selectable)",
                ...
                "system_info": (
                    ...
                    [
                        ...
                        "  • System History: GMP data from EDAstro",
                        "",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                    ],
                ),
                ...
                "custom_route": (
                    ...
                    [
                        ...
                        "  • Finds optimal route through all waypoints",
                        "  • Uses Lin-Kernighan algorithm with fallback",
                        "  • Processing time: 2-5 seconds for 500 systems",
                        "",
                        "⭐ NEUTRON STAR SUPPORT",
                        "  • Neutron Path mode: Estimates jump counts",
                        "  • Select boost multiplier: x4 (standard) or x6 (Caspian)",
                        "  • Uses jump range for calculation (no API calls)",
                        "  • Optimizes waypoint order with TSP algorithm",
                        "  • Plans routes using neutron highway when available",
                        "  • Shows normal vs neutron jump counts",
                        "",
                        "📋 HOW TO USE",
                        "  1. Set starting system (auto-detected or manual)",
                        "  2. Set ending system (optional - for fixed destinations)",
                        "  3. Add waypoint systems (by name or coordinates)",
                        "  4. Set your ship's jump range",
                        "  5. Select mode: Shortest Distance or Neutron Path",
                        "  6. Click 'Optimize Route'",
                        "  7. Copy next system and jump!",
                        "",
                        "📊 OUTPUT",
                        "  • Ordered list of systems to visit",
                        "  • Total distance and jump count",
                        "  • Neutron boost usage per segment",
                ...
                "fuel_tracker": (
                    ...
                    [
                        ...
                        "  • Live fuel level from Journal Status.json",
                        "  • Color-coded progress bar:",
                        "    - Green: >50% fuel",
                        "    - Yellow: 30-50% fuel",
                        "    - Orange: 15-30% fuel (warning)",
                        "    - Red: <15% fuel (critical)",
                        "",
                        "🔊 AUDIO ALERTS",
                        "  • Configurable warning level (5-30%)",
                        "  • Sound alert when fuel drops below warning",
                        "  • 60-second cooldown between alerts (once per minute)",
                        "  • Uses system volume (no app volume control)",
                        "",
                        "🥾 ON-FOOT DETECTION",
                        "  • Shows 'On Foot' when not in ship",
                        "  • Detects via FuelMain=0 in Status.json",
                        "  • Pauses fuel tracking when on foot",
                        "",
                        "⚙️ CONFIGURATION (Settings Tab)",
                        "  • Warning Level: Slider 5-30%",
                        "  • Sound Toggle: Enable/disable alerts",
                        "  • Overlay Position: Drag to reposition",
                        "  • Auto-Launch: Start with application",
                        "",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                    ],
                ),
                ...
                "backup": (
                    ...
                    [
                        ...
                        "",
                        "💾 AUTOMATIC BACKUPS",
                        "  • Created before optimization (timestamped)",
                        "  • Saves route data, progress, and settings",
                        "  • Multiple restore points available",
                        "",
                        "🔄 RESTORE",
                        "  • Load Backup: Restore previous route state",
                        "  • Preserves visited/skipped status",
                        "  • Works with older backup versions",
                        "",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                    ],
                ),
                ...
                "credits": (
                    ...
                    [
                        ...
                        "",
                        "  EDAstro / GEC (edastro.com)",
                        "    • Galactic Mapping Project data",
                        "    • System history and POI information",
                        "    • Used via ID64-based API endpoint",
                        "",
                        "  ⚠️ No official affiliation with any service",
                        "  ⚠️ Thanks to all teams for their amazing work!",
                        "",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "",
                        "👥 SPECIAL THANKS",
